...
UPDATE products SET sold_quantity = 5 WHERE product_id = 1;
UPDATE products SET sold_quantity = 15 WHERE product_id = 2;
UPDATE products SET sold_quantity = 8 WHERE product_id = 3;
